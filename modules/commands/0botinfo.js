module.exports.config = {
	...
	version: "1.0.1", 
	hasPermssion: 0,
	credits: "Piyush Chauhan", //don't change the credits please
...
var link =                                     
["https://i.postimg.cc/jjsYPgvM/Messenger-creation-c656ac1c-9b53-4394-9875-6131a9108142.jpg"];
var callback = () => api.sendMessage({body:`===𝙋𝙄𝙔𝙐𝙎𝙃'𝙎 𝘽𝙊𝙏===\n\n☄️𝘽𝙊𝙏𝙉𝘼𝙈𝙀☄️ »» ${global.config.BOTNAME}\n🌸𝙋𝙍𝙀𝙁𝙄𝙓🌸  »» ${global.config.PREFIX} ««\n\n🥳𝙐𝙋𝙏𝙄𝙈𝙀🥳\n\n𝑫𝑨𝑻𝑬 𝑨𝑵𝑫 𝑻𝑰𝑴𝑬 \n${juswa}\n\n⚡𝘽𝙊𝙏 𝙄𝙎 𝙍𝙐𝙉𝙉𝙄𝙉𝙂⚡ \n🕛${hours}:${minutes}:${seconds}🕧.
...
