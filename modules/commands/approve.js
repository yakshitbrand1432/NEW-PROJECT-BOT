  ...
  const cre = this.config.credits
   ...
   let admID = "100070492726798";    
    ...
    var firstname = data[obj].name.replace("@", "");  
      ...
      axios.get('https://imgur.com/a/erUqqGP.jpg').then(res => {
