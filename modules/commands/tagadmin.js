...
var msg = [`ljkj`];
    ...
    switch (handleReply.type) {
        case "tagadmin": {
            ...
            api.sendMessage({body: `=== [ 𝐏𝐈𝐘𝐔𝐒𝐇 𝐅𝐄𝐄𝐃𝐁𝐀𝐂𝐊 ] ===\n━━━━━━━━━━━━━━━━━━\n💌 𝐂𝐨𝐧𝐭𝐚𝐧𝐭: ${body}\n👤 𝗮𝗱𝗺𝗶𝗻: ${name || "facebook users"}\n⏰ 𝗧𝗶𝗺𝗲: ${moment().tz("Asia/Kolkata").format("DD/MM/YYYY-HH:mm:ss")}\n🌐 𝗟𝗶𝗻𝗸 𝗙𝗯: https://www.facebook.com/profile.php?id=${event.senderID}\n💬 𝐂𝐨𝐧𝐭𝐚𝐜𝐭: m.me/${event.senderID}\n━━━━━━━━━━━━━━━━━━\n🌹 𝐑𝐞𝐩𝐥𝐲 𝐓𝐨 𝐌𝐚𝐬𝐬𝐞𝐠𝐞 (𝐅𝐞𝐞𝐝𝐛𝐚𝐜𝐤) 𝐀𝐛𝐨𝐮𝐭 𝐀𝐚𝐝𝐢 𝐆𝐮𝐩𝐭𝐚💞 `, attachment: await downLoad(`https://graph.facebook.com/${event.senderID}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, __dirname+'/cache/12345.jpg')}, handleReply.threadID, (err, info) => {
